...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/video_4';
  }
  </script>
...
1
    ...
    <td style="padding:3% 0%;width:5%"> 
      ...
      2
          ...
          <td style="padding:3% 0%;width:5%">
            <button class="butactive tablet3" id="three">
            3
            </button>
                </td>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 3</button>
                        
                                      <br><br> <br>
                                  <span id="qfont" >
                                 Introducing the “Brain-Mind” Concept to the children
                                 </span>
                          </center>
                        </div>
      ...
      Neuroplastic changes stop at what age?
 ...
 <table>
 <input type="hidden"    name="question_name1" id="question_name1" value="Neuroplastic changes stop at what age?" >
            <input type="hidden"     name="segment_id"  value="3">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio" onchange="en1()"  required name="first"  id="first" value=" After 12">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="first" id="first" value="After 18" >
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="It varies from one person to another">
   </td>
   <td style="width:96%;height:30px" >
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first"  value="It never stops but slows down gradually">
   </td>
   <td style="width:96%;height:30px"  >
   It never stops but slows down gradually
   ...
   Your child returns from school and shares that he/she has been bullied and doesn’t want to go back
tomorrow. What would you do to comfort him/her?


    </div>
                         
                                  <table >
                                  <input type="hidden"    name="question_name_2" id="question_name_2" value=" Your child returns from school and shares that he/she has been bullied and doesn’t want to go back
tomorrow. What would you do to comfort him/her?" >
            <input type="hidden"     name="segment_id"  value="3">
   <tr>
    ...
    <input type="radio"  onchange="en2()"  required name="radio" id="radio4" value="Yell at your child and tell him/her to face challenge">

    </td>
    <td class="ans" style="width:94%;height:30px"  id="ans1" value="Yell at your child and tell him/her to face challenges"> 
      Yell at your child and tell him/her to face challenges
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio"  onchange="en2()" required name="radio" id="radio4" value="Tell him/her to fight with the bullies">
   </td>
   <td class="ans" style="width:96%;height:30px"  id="ans2">
      Tell him/her to fight with the bullies
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio"   onchange="en2()" required name="radio" id="radio4" value=" Try to tell him/her to be nice to the bullies and at bedtime tell her about how your
best-friendship started with an argument">
   </td>
   <td class="ans" style="width:96%;height:30px"  id="ans3">
    Try to tell him/her to be nice to the bullies and at bedtime tell her about how your
best-friendship started with an argument
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio"  onchange="en2()"  required name="radio" id="radio4" value=" Tell him/her that you will raise a complaint against them with the teacher">
   </td>
   <td class="ans" style="width:96%;height:30px"  id="ans4">
   Tell him/her that you will raise a complaint against them with the teacher
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/video_2">
               <div id="dirbutlast">
                    Last Segment</div>
...
function submit(){
      ...
      $.ajax
        ({
          type: "POST",
          url: "<?php echo base_url() ?>video/segment_3",
