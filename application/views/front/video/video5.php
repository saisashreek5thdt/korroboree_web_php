...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/video_6';
  }
  </script>
...
1
    ...
    <td style="padding:3% 0%;width:5%"> 
      ...
      2
          ...
          <td style="padding:3% 0%;width:5%">
           ...
           4
                ...
                <td style="padding:3% 0%;width:5%">
                  <button class="butactive tablet5" id="five">
                  5
                  </button>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 5</button>
      ...
      How can we focus on essential socio-emotional development in young students?
 ...
 <table>
 <input type="hidden"    name="question_name1" id="question_name1" value="How can we focus on essential socio-emotional development in young students?" >
            <input type="hidden"     name="segment_id"  value="5">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio" onchange="en1()"  required name="first" id="first" value=" By making them memorize lessons">

    </td>
    <td style="width:94%;height:30px;"  > 
       By making them memorize lessons
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="first" id="first" value="By inculcating life values and sharing real-life experiences">
   </td>
   <td style="width:96%;height:30px"  >
     By inculcating life values and sharing real-life experiences
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="By taking more standardized tests">
   </td>
   <td style="width:96%;height:30px" >
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="By making them read more books">
   </td>
   <td style="width:96%;height:30px"  >
 By making them read more books
   ...
   As a parent, which of school would you want your child to be in?

    </div>
                         
                                  <table >
                                  <input type="hidden"    name="question_name_2" id="question_name_2" value="As a parent, which of school would you want your child to be in?" >
            <input type="hidden"     name="segment_id"  value="5">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio"  onchange="en2()"  required name="radio" id="radio4" value="A school where discipline is the law">

    </td>
    <td class="ans" style="width:94%;height:30px"  id="ans1"> 
     A school where discipline is the law
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio"  onchange="en2()" required name="radio" id="radio4" value="A school where tests are taken every week">
   </td>
   <td class="ans" style="width:96%;height:30px"  id="ans2">
      A school where tests are taken every week
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio"   onchange="en2()" required name="radio" id="radio4" value="A school where teachers are respected and are free to inculcate life-values in students">
   </td>
   <td class="ans" style="width:96%;height:30px"  id="ans3">
    A school where teachers are respected and are free to inculcate life-values in students
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio"  onchange="en2()"  required name="radio" id="radio4" value="A school where more importance is given to academics than sports, music or any other
co-curricular activities">
   </td>
   <td class="ans" style="width:96%;height:30px"  id="ans4">
   A school where more importance is given to academics than sports, music or any other
co-curricular activities
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/video_4">
               <div id="dirbutlast">
                    Last Segment</div>
...
function submit(){
     // alert(first);
      ...
      $.ajax
        ({
          type: "POST",
          url: "<?php echo base_url() ?>video/segment_5",
