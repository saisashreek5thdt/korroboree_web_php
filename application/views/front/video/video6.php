...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/video_7';
  }
  </script>
...
1
           ...
           4
                ...
                <td style="padding:3% 0%;width:5%">
                  ...
                  5
                        ...
                        <button class="butactive tablet6" id="six">
                        6
                        </button>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 6</button>
          ...
          <div class="col-md-10  col-xl-4 col-lg-4 videocol2" id="questab" style="display: none">
                           <center>
                                 <button class="segmentbutton">Segment 6</button>
                                      ...
                                      <br> <br>
                                  <div  id="qstn1" class="col-md-12 qstn" >   
 ...
 <input type="hidden"    name="question_name1" id="question_name1" value=" Why do you think Rick tells us not to speak or act out of anger?" >
            <input type="hidden"     name="segment_id"  value="6">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio" onchange="en1()"  required name="first" id="first" value=" Anger has a deep impact and anything said or done out of anger can have long-lasting
effects on young minds">

    </td>
    <td class="ans" style="width:94%;height:30px;"  > 
       Anger has a deep impact and anything said or done out of anger can have long-lasting
effects on young minds
 </td>
   </tr>
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="first" id="first" value="Being angry harms our health">
   </td>
   <td class="ans" style="width:96%;height:30px"  >
     Being angry harms our health
 </td>
  </tr>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value=" Our children will not listen to us if we shout at them or punish them">
   </td>
   <td class="ans" style="width:96%;height:30px" >
  Our children will not listen to us if we shout at them or punish them
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="Anger doesn't help correct children's problems">
   </td>
   <td class="ans" style="width:96%;height:30px"  >
 Anger doesn't help correct children's problems
   ...
   Your child wants to join art classes but you don’t know anything about art. What should you do?


    </div>
                         
                                  <table >
                                  <input type="hidden"    name="question_name_2" id="question_name_2" value=" Your child wants to join art classes but you don’t know anything about art. What should you do?" >
            <input type="hidden"     name="segment_id"  value="6">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio"  onchange="en2()"  required name="radio" id="radio4" value=" Let him/her be their self and join the classes they enjoy">

    </td>
    <td class="ans" style="width:94%;height:30px"  id="ans1"> 
   Let him/her be their self and join the classes they enjoy
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio"  onchange="en2()" required name="radio" id="radio4" value=" Tell them to wait while you learn about art classes and then allow them to join">
   </td>
   <td class="ans" style="width:96%;height:30px"  id="ans2">
      Tell them to wait while you learn about art classes and then allow them to join
     </td>
  </tr>
   ...
   Make excuses and then tell them not to join
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/video_5">
               <div id="dirbutlast">
                    Last Segment</div>
...
function submit(){
      ...
      $.ajax
        ({
          type: "POST",
          url: "<?php echo base_url() ?>video/segment_6",
