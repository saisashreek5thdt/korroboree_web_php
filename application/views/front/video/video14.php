...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/k_4';
  }
  </script>
                                                     ...
                                                     11
                                                            ...
                                                            12
                                                                 ...
                                                                 13
                                                                      ...
                                                                      <td style="padding:3% 0%;width:5%">
                                                                        <button class="butactive tablet14" id="fourteen">
                                                                        14
                                                                        </button>
                                                                            </td>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 14</button>
 ...
 All of the brain
                          ...
                          <div style="padding:18px 10px;background:#5B00E2;width:100%;left:0;height:60px;position: absolute;bottom: 0px;">
                            ...
                            <div class="row justify-content-md-around">
                             <div class="col-8 col-sm-8 col-md-10 col-lg-8 col-xl-8" style="display: none;"><button class="disablebutton" disabled >Back</button></div>
                              <div class="col-4 col-sm-4 col-md-2 col-lg-4 col-xl-4" style="display: none;"><button class="enablebutton" disabled id="n1" onclick="next1()" >Next</button></div>
   ...
   Make excuses and then tell them not to join
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/video_13">
               <div id="dirbutlast">
                    Last Segment</div>
