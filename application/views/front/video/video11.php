...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/video_12';
  }
  </script>
  ...
  <div class="container-fluid">
               ...
               <div class="row justify-content-md-center">
                   <div class="col-md-2 col-xl-2 col-lg-2" style="height:70px;" >
                    <center>
                    <img src="ass<?php echo base_url() ?>frontassets/videojunralets/images/logo/klogo.png" id="logomain">
                  </center> 
                   </div>
               </div>
                                   ...
                                   8
                                          ...
                                          9
                                                ...
                                                10
                                                    ...
                                                    <td style="padding:3% 0%;width:5%"> 
                                                      <button class="butactive tablet11" id="eleven">
                                                     11
                                                      </button>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 11</button>
                        
                                      <br><br> <br>
                                  <span id="qfont" >
                              Finding what’s sacred and meaningful fo kids
       ...
       Why is finding what’s sacred for your kid important?
    </div>

                         
 <table>
 <input type="hidden"    name="question_name1" id="question_name1" value="Why is finding what’s sacred for your kid important?" >
            <input type="hidden"     name="segment_id"  value="11">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio" onchange="en1()"  required name="first" id="first" value="To help them perform well in exams">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="first" id="first" value=" To enable a purposeful being">
   </td>
   <td style="width:96%;height:30px"  >
     To enable a purposeful being
 </td>
  </tr>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="To help them become wealthy in future">
   </td>
   <td style="width:96%;height:30px" >
   To help them become wealthy in future
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value=" To make them excel in athletics">
   </td>
   <td style="width:96%;height:30px"  >
 To make them excel in athletics
  ...
  Imagine everyone says your child is ordinary with no special talent. He feeds birds early in the
morning, goes to school, comes back home and leads a very average life as compared to kids who
attend extra-curricular classes and do well in studies. Ask yourself if you are a proud parent.

    </div>
                         
                                  <table style="display: none;" >
                                  <table >
                                  <input type="hidden"    name="question_name_2" id="question_name_2" value="Imagine everyone says your child is ordinary with no special talent. He feeds birds early in the
morning, goes to school, comes back home and leads a very average life as compared to kids who
attend extra-curricular classes and do well in studies. Ask yourself if you are a proud parent." >
            <input type="hidden"     name="segment_id"  value="11">
   <tr>
   ...
   Make excuses and then tell them not to join
                          ...
                          <div style="padding:18px 10px;background:#5B00E2;width:100%;left:0;height:60px;position: absolute;bottom: 0px">
                            ...
                            <div class="row justify-content-md-around">
                             <div class="col-8 col-sm-8 col-md-10 col-lg-8 col-xl-8"><button class="back"  onclick="back2()">Back</button></div>
                               <div class="col-4 col-sm-4 col-md-2 col-lg-4 col-xl-4"><button class="enablebutton" id="n2" onclick="submit()">Submit</button></div>
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/video_10">
               <div id="dirbutlast">
                    Last Segment</div>
...
function submit(){
      ...
      $.ajax
        ({
          type: "POST",
          url: "<?php echo base_url() ?>video/segment_11",
