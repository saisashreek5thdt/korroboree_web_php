...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/video_14';
  }
  </script>
...
1
    ...
    <td style="padding:3% 0%;width:5%"> 
                                                    ...
                                                    <td style="padding:3% 0%;width:5%"> 
                                                     ...
                                                     11
                                                            ...
                                                            12
                                                                  ...
                                                                  <button class="butactive tablet13" id="thirteen">
                                                                 13
                                                                  </button>
                                                                      </td>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 13</button>
                        
                                      <br><br> <br>
                                  <span id="qfont" >
                           Understanding Doing and Being
     ...
     What part of the brain is associated with day-dreaming?

    </div>

                         
 <table>
 <input type="hidden"    name="question_name1" id="question_name1" value="What part of the brain is associated with day-dreaming?" >
            <input type="hidden"     name="segment_id"  value="13">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio" onchange="en1()"  required name="first" id="first" value="Rear part">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="first" id="first" value="Front part">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="Middle part">
   </td>
   <td style="width:96%;height:30px" >
   Middle part
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="All of the brain">
   </td>
   <td style="width:96%;height:30px"  >
 All of the brain
     </td>
...
What can we do to transcend to a mode of just being and not doing anything?

    </div>
                         
                                  <table >
                                  <input type="hidden"    name="question_name_2" id="question_name_2" value="What can we do to transcend to a mode of just being and not doing anything?" >
            <input type="hidden"     name="segment_id"  value="13">
   ...
   Make excuses and then tell them not to join
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/video_12">
               <div id="dirbutlast">
                    Last Segment</div>
...
function submit(){
     // alert(first);
      ...
      $.ajax
        ({
          type: "POST",
          url: "<?php echo base_url() ?>video/segment_13",
