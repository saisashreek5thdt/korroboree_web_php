...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/video_13';
  }
  </script>
...
1
    ...
    <td style="padding:3% 0%;width:5%"> 
                                                ...
                                                10
                                                    ...
                                                    <td style="padding:3% 0%;width:5%"> 
                                                     ...
                                                     11
                                                            ...
                                                            <button class="butactive tablet12" id="twelve">
                                                            12
                                                            </button>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 12</button>
                        
                                      <br><br> <br>
                                  <span id="qfont" >
                            Why is looking at a situation from various perspectives important?
     ...
     Why do you think it is important to be able to view one situation from different perspectives?
 ...
 <table>
 <input type="hidden"    name="question_name1" id="question_name1" value="Why do you think it is important to be able to view one situation from different perspectives??" >
            <input type="hidden"     name="segment_id"  value="12">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio" onchange="en1()"  required name="first" id="first" value=" To know that we are not always right">

    </td>
    <td style="width:94%;height:30px;"  > 
       To know that we are not always right
 </td>
   </tr>

   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="first" id="first" value="To make better decisions in future">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="To enable our kids to do the same and be compassionate and empathetic towards others
who are different from us">
   </td>
   <td style="width:96%;height:30px" >
   To enable our kids to do the same and be compassionate and empathetic towards others
who are different from us
 ...
 You pick up an argument with your partner in front of your child. Once things settle down, what do
you think you should do?

    </div>
                         
                                  <table >
                                  <input type="hidden"    name="question_name_2" id="question_name_2" value="You pick up an argument with your partner in front of your child. Once things settle down, what do
you think you should do?" >
   ...
   <tr>
    ...
    <input type="radio"  onchange="en2()"  required name="radio" id="radio4" value="Ignore the fact that your kid watched you argue">

    </td>
    <td style="width:94%;height:30px"  id="ans1"> 
    Ignore the fact that your kid watched you argue
      </td>
   </tr>

   <tr>
    <td style="padding:4px 16px">
   <input type="radio"  onchange="en2()" required name="radio" id="radio4" value=" Explain to him/her the differences in opinion that led to the argument (in a way that he/she
can understand)">
   </td>
   <td style="width:96%;height:30px"  id="ans2">
     Explain to him/her the differences in opinion that led to the argument (in a way that he/she
can understand)
</td>
  </tr>
   ...
   Make excuses and then tell them not to join
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/video_11">
               <div id="dirbutlast">
                    Last Segment</div>
...
function submit(){
     // alert(first);
      ...
      $.ajax
        ({
          type: "POST",
          url: "<?php echo base_url() ?>video/segment_12",
