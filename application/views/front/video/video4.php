...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/video_5';
  }
  </script>
...
1
    ...
    <td style="padding:3% 0%;width:5%"> 
      ...
      2
          ...
          <td style="padding:3% 0%;width:5%">
            <button class="butactive tablet4" id="four">
           4
            </button>
                </td>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 4</button>
                        
                                      <br><br> <br>
                                  <span id="qfont" >
                                How to deal with suffering and usher in happiness amidst adversities
                                 </span>
                          </center>
                        </div>
      ...
      What is the best way to face a challenge or a negative situation?
 ...
 <table>
 <input type="hidden"    name="question_name1" id="question_name1" value=" What is the best way to face a challenge or a negative situation?" >
            <input type="hidden"     name="segment_id"  value="4">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio" onchange="en1()"  required name="first" id="first" value="Run away from it">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="first" id="first" value=" Avoid it">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="Face it with all your inner resources to help you remain resilient">
   </td>
   <td style="width:96%;height:30px" >
   Face it with all your inner resources to help you remain resilient
     </td>
  </tr>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="  Let time solve the problem">
   </td>
   <td style="width:96%;height:30px"  >
  Let time solve the problem
   ...
   Your child has not completed a homework and doesn’t want to go to school for the fear of being
scolded. What should you do?


    </div>
                         
                                  <table >
                                  <input type="hidden"    name="question_name_2" id="question_name_2" value=" Your child has not completed a homework and doesn’t want to go to school for the fear of being
scolded. What should you do?" >
            <input type="hidden"     name="segment_id"  value="4">
   <tr>
    ...
    <input type="radio"  onchange="en2()"  required name="radio" id="radio4" value="Do the homework yourself to avoid him/her from being scolded">

    </td>
    <td class="ans" style="width:94%;height:30px"  id="ans1"> 
     Do the homework yourself to avoid him/her from being scolded
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio"  onchange="en2()" required name="radio" id="radio4" value="Scold them yourself and then send them to school">
   </td>
   <td class="ans" style="width:96%;height:30px"  id="ans2">
      Scold them yourself and then send them to school
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio"   onchange="en2()" required name="radio" id="radio4" value="Let them skip school">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio"  onchange="en2()"  required name="radio" id="radio4" value="Encourage them to attend school and tell them that being scolded by your teachers isn’t a
bad thing as they are just trying to make you learn but also tell them to take on
responsibilities and complete homework on their own">
   </td>
   <td class="ans" style="width:96%;height:30px"  id="ans4">
   Encourage them to attend school and tell them that being scolded by your teachers isn’t a
bad thing as they are just trying to make you learn but also tell them to take on
responsibilities and complete homework on their own
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/video_3">
               <div id="dirbutlast">
                    Last Segment</div>
...
function submit(){
      ...
      $.ajax
        ({
          type: "POST",
          url: "<?php echo base_url() ?>video/segment_4",
