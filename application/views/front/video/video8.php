...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/video_9';
  }
  </script>
...
1
                  ...
                  5
                        ...
                        6
                              ...
                              7
                                    ...
                                    <button class="butactive tablet8" id="eight">
                                   8
                                    </button>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 8</button>
                        
                                      <br><br> <br>
                                  <span id="qfont" >
                              Thoughts on Depression-the dreaded D-word
 ...
 <table>
 <input type="hidden"    name="question_name1" id="question_name1" value="What is the leading cause of depression?" >
            <input type="hidden"     name="segment_id"  value="8">
   <tr>
 
     <td style="padding:4px 16px">
      
    <input type="radio" onchange="en1()"  required name="first" id="first" value="Loneliness">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="first" id="first" value="Shredded connections">
   </td>
   <td style="width:96%;height:30px"  >
     Shredded connections
 </td>
  </tr>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value="  Expectations to multitask">
   </td>
   <td style="width:96%;height:30px" >
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="first" id="first" value=" All of these">
   </td>
   <td style="width:96%;height:30px"  >
 All of these
   ...
   Imagine you get a job offer that pays less but is fulfilling; something that you wanted to do all your
life. What do you think you should do given there is someone who can run the family?

    </div>
                         
                                  <table >
                                  <input type="hidden"    name="question_name_2" id="question_name_2" value="  Imagine you get a job offer that pays less but is fulfilling; something that you wanted to do all your
life. What do you think you should do given there is someone who can run the family?" >
            <input type="hidden"     name="segment_id"  value="8">
   <tr>
    ...
    <input type="radio"  onchange="en2()"  required name="radio" id="radio4" value="Take the job because when your work is rewarding you feel Eudemonic">

    </td>
    <td style="width:94%;height:30px"  id="ans1"> 
    Take the job because when your work is rewarding you feel Eudemonic
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio"  onchange="en2()" required name="radio" id="radio4" value=" We work for money so do not settle for a low paying job">
   </td>
   <td style="width:96%;height:30px"  id="ans2">
      We work for money so do not settle for a low paying job
   ...
   Make excuses and then tell them not to join
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/video_7">
               <div id="dirbutlast">
                    Last Segment</div>
...
function submit(){
      ...
      $.ajax
        ({
          type: "POST",
          url: "<?php echo base_url() ?>video/segment_8",
