...
document.getElementById("sub").style.display="block";
  ...
  function endsx(){
      ...
      window.location.href = '<?php echo base_url() ?>video/video_3';
  }
  </script>
...
1
    ...
    <td style="padding:3% 0%;width:5%"> 
      <button class="butactive tablet2" id="two">
      2
      </button>
          </td>
      ...
      <div class=" col-1 col-md-1  col-xl-1 col-lg-1" id="block"></div>
                  ...
                  <div class="row  justify-content-md-center" style=" height:auto;">
                       ...
                       <div class="col-md-10   col-xl-4 col-lg-4" id="videocol"  >
                           <center>
                                 <button class="segmentbutton">Segment 2</button>
                        
                                      <br><br> <br>
                                  <span id="qfont" >
                                  Train the mind to train the brain to train the mind!
                                 </span>
                          </center>
                        </div>
    ...
    <div class="col-md-10  col-xl-4 col-lg-4 videocol2" id="questab" style="display: none">
        <center>
          <button class="segmentbutton">Segment 2</button>
          <br> <br>
            <div  id="qstn1" class="col-md-12" > We can train our mind in a way so that it can change our brain.</div>
            <table>
               <!-- <form id="segment_2"> -->
                 
 <input type="hidden"    name="question_name1" id="question_name1" value="We can train our mind in a way so that it can change our brain." >
            <input type="hidden"     name="segment_id"  value="2">
                <tr>
                    <td style="padding:4px 16px">
                       <input type="radio" onchange="en1()"  required name="first" id="first" value=" True. When our minds take in the good in everything our brains start to hold only">
                    </td>
                    <td style="width:94%;height:30px;padding-top: 10px;"  > 
                        True. When our minds take in the good in everything our brains start to hold only
                    </td>
                </tr>
                <tr>
                  <td style="padding:4px 16px">
                      <input type="radio" required  onchange="en1()"  name="first" id="first" value="False. Brains and Minds are the same">
                  </td>
                  <td style="width:96%;height:30px"  >False. Brains and Minds are the same</td>
                </tr>
                <tr style="display: none;">
                    <td style="padding:4px 16px">
                      <input type="radio" onchange="en1()"   required name="first" id="first"  value="Neutral News">
                    </td>
                    <td style="width:96%;height:30px" >  Neutral News</td>
                </tr>
                <tr style="display: none;">
                    <td style="padding:4px 16px">
                       <input type="radio" onchange="en1()"   required name="first" id="first" value= "Both Bad and Good news">
                    </td>
      ...
      <div class="col-md-10  col-xl-4 col-lg-4 videocol2" id="questab2" style="display: none">
        <center>
              <button class="segmentbutton">Segment 2</button>
                <br> <br>
                  <div  id="qstn1" class="col-md-12 pb-2 qstn" >Imagine that your child is melancholic all the time. What would you do to change his/her general nature?
                  </div>
                         
          <table >
              <input type="hidden"    name="question_name_2" id="question_name_2" value="Imagine that your child is melancholic all the time. What would you do to change his/her general nature?" >
            <input type="hidden"     name="segment_id"  value="2">
            <tr>
              <td style="padding:4px 16px">
                <input type="radio"  onchange="en2()"  required name="radio" id="radio3" value="Try to cheer him/her up all the time">
              </td>
               <td class="ans" style="width:94%;height:30px"  id="ans1"> Try to cheer him/her up all the time</td>
            </tr>
            <tr>
               <td style="padding:4px 16px">
                   <input type="radio"  onchange="en2()" required name="radio" id="radio3" value="Tell him/her to look at the bright side of life">
               </td>
               <td class="ans" style="width:96%;height:30px"  id="ans2">Tell him/her to look at the bright side of life</td>
            </tr>
            <tr>
              <td style="padding:4px 16px">
                <input type="radio"   onchange="en2()" required name="radio" id="radio3" value="Set an example by doing little good deeds yourself and showing the child that little experiences bring you immense inner happiness">
              </td>
              <td class="ans" style="width:96%;height:30px"  id="ans3">Set an example by doing little good deeds yourself and showing the child that little experiences bring you immense inner happiness
             </td>
            </tr>
            <tr>
               <td style="padding:4px 16px">
                 <input type="radio"  onchange="en2()"  required name="radio" id="radio3">
               </td>
               <td class="ans" style="width:96%;height:30px"  id="ans4">Let him/her be the way he/she is</td>
            </tr>
          </table>
        </center>
          <div style="padding:18px 10px;background:#5B00E2;width:100%;left:0;height:60px;position: absolute;bottom: 0px">
              <div class="row justify-content-md-around">
                <div class="col-8 col-sm-8 col-md-10 col-lg-8 col-xl-8"><button class="back"  onclick="back2()">Back</button></div>
                    <div class="col-4 col-sm-4 col-md-2 col-lg-4 col-xl-4"><button class="enablebutton submit"  disabled id="n2" onclick="submit()">Submit</button></div>
  ...
  <!-- </form> -->
    ...
    <div id="block2"></div>
          <div class="row justify-content-md-center" style="height:60px;" id="bottomrow">
                  <a href="<?php echo base_url() ?>video/v_2">
               <div id="dirbutlast">
                    Last Segment</div>
...
function submit(){
      //alert(name);
      var name = $('#first:checked').val();
      var email = $('#radio3:checked').val();
      var message = $('#question_name1').val();
      var message1 = $('#question_name_2').val();
      $.ajax
        ({
          type: "POST",
          url: "<?php echo base_url() ?>video/segment_2",
          data: { "name": name, "email": email, "message": message,"message1": message1 },
