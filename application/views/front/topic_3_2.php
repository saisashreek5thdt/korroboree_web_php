    ...
    <!-- popup end -->
      ...
      <div class="row" >
        <div class="col padding_error" align="center" >
          <img src="<?php echo base_url() ?>frontassets/images/background/question.png" alt=""  class="game_bg">
          <div class="why_r_u">
            Why are you here?
          </div>
          <div class="write write_inline" >
            <a href="<?php echo base_url() ?>topics/topic_3_c"> <img src="<?php echo base_url() ?>frontassets/images/background/butn_bg.png" alt="" class="write_box blob" >
            <div class="lets_write">
              Write
            </div>
          </a>
          </div>
