<?php include("includes/header.php"); ?>
  <body>
    ...
    <div class="row">
      ...
      <div class="row" >
        <div class="col-lg-8 col-md-8 moon family_top_text why_top" style="margin-top: 5px;" >
          What is your area of interest and passion that brings scale to your powerful ‘Why’?
        </div>
        <div class="col-lg-4 col-md-4 rigt_se" align="right">
          <img src="<?php echo base_url() ?>frontassets/images/icons/book.png" alt="" data-toggle="tooltip" data-placement="bottom" title="Journal entry" class="right_side_icon ">
          <img src="<?php echo base_url() ?>frontassets/images/icons/boy_g.png" data-toggle="tooltip" data-placement="bottom" title="Individual activity  " alt=""  class="right_side_icon ">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8" align="center">
          <img src="<?php echo base_url() ?>frontassets/images/gif/successfully_completed_gif_.gif" alt="" width="25%" class="topic_5_suces success-panda">
        ...
        <div class="row">
          ...
          <div class="col" align="right">
            <img src="<?php echo base_url() ?>frontassets/images/gif/mailbox_gif--2.gif" class="tpc_5_1_gif" alt="" width="16%" >
          </div>
          </div>
