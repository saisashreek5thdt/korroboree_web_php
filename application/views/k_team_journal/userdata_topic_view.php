...
//print_r($topic); exit;   
                                if(is_array($topic)){ 
                                 ...
                                 <li class="page-item active"><?php echo $v->video  ?></li>
                                    <?php } else if($v->topic_number == 2){  ?>
                                         <li class="page-item active"><?php echo $v->title_1  ?>  ?></li>
                                         <li class="page-item active"><?php echo $v->title_2  ?></li>
                                          <li class="page-item active"><?php echo $v->title_3  ?></li>
                                         <li class="page-item active"><?php echo $v->title_4  ?></li>
