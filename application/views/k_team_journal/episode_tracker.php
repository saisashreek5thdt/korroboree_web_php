                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-6">
                                 <div class="text-right">
                                    ...
                                    <a class="btn btn-primary" href="<?php base_url(); ?>episode_create"> <i data-feather="plus-square"> </i>Create New Episode</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                                    ...
                                    <div class="row">
                                       <div class="col-xl-4 col-lg-6">
                                          <div class="project-box">
                                             ...
                                             <p>No of Topics and Activities Created</p>
                                             <div class="row details">
                                                <div class="col-6"><span>Topics </span></div>
                                       ...
                                       <div class="col-xl-4 col-lg-6">
                                          <div class="project-box">
                                             ...
                                             <div class="row details">
                                                ...
                                                <div class="col-6"> <span>Activites</span></div>
                                                <div class="col-6 text-primary">24</div>
                                             </div>
                                             <div class="project-status mt-4">
                                                <div class="media mb-0">
