...
<html lang="en">
   <head>
	  ...
	  <meta name="msapplication-TileImage" content="<?php base_url(); ?>adminassets/images/logo/logo2.png" /> 
      <link rel="icon" href="<?php base_url(); ?>adminassets/images/logo/logo2.png" type="image/x-icon">
      <link rel="shortcut icon" href="<?php base_url(); ?>adminassets/images/logo/logo2.png" type="image/x-icon">
	  ...
	  <link rel="stylesheet" type="text/css" href="<?php   base_url(); ?>adminassets/css/fontawesome.css"> 
      <!-- ico-font-->
                  ...
                  <ul class="nav-menus">
                     ...
                     <li class="profile-nav onhover-dropdown p-0 mr-0">
                        ...
                        <ul class="profile-dropdown onhover-show-div">
                           ...
                           <li>
							   <a href="<?php echo base_url(); ?>enter">
