                     ...
                     <div class="col-xl-12 xl-60">
                        <div class="row">
                           <div class="col-xl-4 xl-100">
                               <?php  foreach ($episode_video as $video) {  ?>
                              <div class="card">
                                    ...
                                    <div class="card-body">
                                       <div class="media">
                                          ...
                                          <div class="media-body">
                                               <form  method="post" id="<?php echo $video->episode_number ?>" novalidate="" enctype="multipart/form-data" action="<?php base_url(); ?>userdata_topic_view_v">
                                             <input type="hidden" name="id" value="<?php echo $video->episode_number ?>">
                                             <h6 class="f-w-600">
                                       <a type="button" href="javascript:{}" onclick="document.getElementById('<?php echo $video->episode_number ?>').submit();" > <?php echo $video->title;  ?></a>  
                                       </form>
