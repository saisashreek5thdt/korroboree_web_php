                           ...
                           <div class="card">
                              <div class="card-body">
                                 <div class="product-slider owl-carousel owl-theme" id="sync1">
                                    <div class="item"><img src="<?php base_url(); ?>adminassets/images/ecommerce/01.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>adminassets/images/ecommerce/02.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>adminassets/images/ecommerce/03.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>adminassets/images/ecommerce/04.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>adminassets/images/ecommerce/05.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>adminassets/images/ecommerce/06.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>adminassets/images/ecommerce/07.jpg" alt=""></div>
                                    <div class="item"><img src="<?php base_url(); ?>adminassets/images/ecommerce/08.jpg" alt=""></div>
                                 </div>
